...
function makeDefaults() {
  const defaults = {
    ...
    features: {
      ...
      /*
           * features.useTenantIssuer
           *
           * title: Issuers are unique based on the tenant identifier
           *
           * description: Enables setting the issuer at tenant level
           */
      useTenantIssuer: { enabled: false },
    },
